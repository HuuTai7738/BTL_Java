 ...
 * @author Admin
 */
public class QuanLyHoatDong extends javax.swing.JFrame {

    /**
     * Creates new form QuanLyHoatDong
     */
    ArrayList<HoatDong> listHD;
    ...
    public QuanLyHoatDong() {
        ...
        con.getConnection();
        listHD = con.layDanhSachHoatDong();
        hienThiDuLieu();

    }

    public void hienThiDuLieu() {
        tblHoatDong.setModel(new QLHDCustomTable(listHD));
    }
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        ArrayList<HoatDong> listTimKiem = new ArrayList<>();
        if (maSV.trim().isEmpty()) {
            ...
            for (HoatDong x : listHD) {
                if (x.getMaSV().equals(maSV)) {
                    listTimKiem.add(x);
                }
            }
            tblHoatDong.setModel(new QLHDCustomTable(listTimKiem));
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        int diemCong=0;
        if(maSV.trim().isEmpty() || maHD.trim().isEmpty()|| tenHD.trim().isEmpty() || txtDiemCong.getText().trim().isEmpty()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyHoatDong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
